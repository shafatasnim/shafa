		...
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					...
					<form action="{{url('admin/santri/update',$santri->id)}}" method="post" enctype="multipart/form-data">
						@csrf
						@method("PUT")
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input class="form-control" name="no_kk" required="" placeholder="Nomor Kartu Keluarga"></input>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control" name="nik_ayah" required="" placeholder="Nomor Induk Keluarga"></input>
								</div>
							</div>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<input class="form-control" name="nik_ibu" required="" placeholder="Nomor Induk Keluarga"></input>
								</div>
							</div>
						</div>
